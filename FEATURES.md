...
- **V5 Extras**: free-drag character positioning (32 characters), TRANSPARENT BG toggle (RGBA output over a checkerboard), auto-`teXt:` from quoted strings (base + character prompts, blank-line separated, last in the base caption), V5 tags in autocomplete, V5 quality/UC style presets
